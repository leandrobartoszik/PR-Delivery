                        ...
                        function ajx1(){
                           ...
                           ajax.onreadystatechange = function(){
                              ...
                              if(ajax.readyState == 4 && ajax.status == 200){
                                 ...
                                 setTimeout(ajx1, 4000); // chama a função novamente após 4 segundos
                              }
                           }
                           ajax.open("GET", "ajax-pericles.php"); // página a ser requisitada
                        ...
                        function ajx(){
                           ...
                           ajax.onreadystatechange = function(){
                              ...
                              if(ajax.readyState == 4 && ajax.status == 200){
                                 ...
                                 setTimeout(ajx, 4000); // chama a função novamente após 4 segundos
                              }
                           }
                           ajax.open("GET", "ajax-pericles2.php"); // página a ser requisitada
                           ajax.send(); // envia a requisição
                        }
                        ajx(); // chama a função
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Se é isso que quer, então clique em sair para encerrar sua sessão!</div>
